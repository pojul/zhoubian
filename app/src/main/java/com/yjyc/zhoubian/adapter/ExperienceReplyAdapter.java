...
public class ExperienceReplyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements PostDetailsFragment.OnItemClickListener {
    ...
    public ExperienceReplyAdapter(Context mContext, List<ReplyPostList.ReplyPost> replys) {
    ...
    public void seExpericeId(int experienceId, int postOwnId){
        this.postId = experienceId;
