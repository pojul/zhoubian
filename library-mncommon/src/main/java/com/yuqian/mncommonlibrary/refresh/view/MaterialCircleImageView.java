 ...
 * platforms.
 */
public class MaterialCircleImageView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = MaterialCircleImageView.this.getWidth();
            final int viewHeight = MaterialCircleImageView.this.getHeight();
