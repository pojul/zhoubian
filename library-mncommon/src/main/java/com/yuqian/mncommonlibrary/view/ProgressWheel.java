package com.yuqian.mncommonlibrary.view;
...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.MNBaseProgressWheel_mnbase_view_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.MNBaseProgressWheel_mnbase_view_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.MNBaseProgressWheel_mnbase_view_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.MNBaseProgressWheel_mnbase_view_rimWidth, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.MNBaseProgressWheel_mnbase_view_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.MNBaseProgressWheel_mnbase_view_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.MNBaseProgressWheel_mnbase_view_barColor, barColor);

        rimColor = a.getColor(R.styleable.MNBaseProgressWheel_mnbase_view_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.MNBaseProgressWheel_mnbase_view_linearProgress, false);

        if (a.getBoolean(R.styleable.MNBaseProgressWheel_mnbase_view_progressIndeterminate, false)) {
            spin();
        }
