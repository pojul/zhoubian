...
public class MClearEditText extends EditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //是否展示底部线
        showBottomLine = ta.getBoolean(R.styleable.MClearEditText_mClearEditText_showBottomLine, false);
        //底部线的颜色
    ...
    private void setDrawable() {
        ...
        if (mClearDrawable == null) {
            //获取默认图标
            mClearDrawable = getResources().getDrawable(R.drawable.mclearedittext_clear_icon);
        }
